...
; Additional axiom
(assert (exists ((s0_h11 Bool) (s0_h33 Bool) (S0_X29 Individual)) (s0_root s0_h11 s0_h33 S0_X29)))
...
; Additional axiom
(assert (exists ((s1_h13 Bool) (s1_h39 Bool) (S1_X32 Individual)) (s1_root s1_h13 s1_h39 S1_X32)))
...
; Additional axiom
(assert (exists ((s2_h35 Bool) (s2_h17 Bool) (S2_X10 Individual)) (s2_root s2_h35 s2_h17 S2_X10)))
...
; Additional axiom
(assert (exists ((s3_h11 Bool) (s3_h24 Bool) (S3_X20 Individual)) (s3_root s3_h11 s3_h24 S3_X20)))
...
; Additional axiom
(assert (exists ((s4_h4 Bool) (s4_h16 Bool) (S4_X9 Individual)) (s4_root s4_h4 s4_h16 S4_X9)))
...
; Additional axiom
(assert (exists ((s5_h4 Bool) (s5_h9 Bool) (S5_X8 Individual)) (s5_root s5_h4 s5_h9 S5_X8)))
...
; Additional axiom
(assert (exists ((s6_h4 Bool) (s6_h20 Bool) (S6_X8 Individual)) (s6_root s6_h4 s6_h20 S6_X8)))
...
; Additional axiom
(assert (exists ((s7_h5 Bool) (s7_h9 Bool) (S7_X8 Individual)) (s7_root s7_h5 s7_h9 S7_X8)))
...
; Additional axiom
(assert (exists ((s8_h13 Bool) (s8_e11 Event)) (s8_root s8_h13 s8_e11)))
...
; Additional axiom
(assert (exists ((s9_h1 Bool) (s9_h16 Bool) (S9_X13 Individual)) (s9_root s9_h1 s9_h16 S9_X13)))
