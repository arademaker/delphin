...
/-
ENT: how is your salad?

[ LTOP: h0
INDEX: e2 [ e SF: ques TENSE: pres MOOD: indicative PROG: - PERF: - ]
RELS: <
 [ unspec_a<0:3>        LBL: h4  ARG0: e2 ARG1: x3 [ x PERS: 3 NUM: sg ] ]
 ...
 [ poss<7:11>           LBL: h13 ARG0: e14 [ e SF: prop TENSE: untensed MOOD: indicative PROG: - PERF: - ]
                                 ARG1: x3 ARG2: x15 [ x PERS: 2 PT: std ] ]
...
section test
 ...
 axiom which_q : x → Prop → Prop → Prop
 axiom pronoun_q : x → Prop → Prop → Prop
 axiom def_explicit_q : x → Prop → Prop

 axiom unspec_a : e → x → Prop
 axiom property : x → Prop
 axiom prpstn_to_prop : e → Prop → x → Prop

 axiom poss : e → x → x → Prop
 axiom pron : x → Prop
 axiom _salad_n_1 : x → Prop

 def q1 : Prop := ∃ x3, (∃ x15, pron x15 ∧ ∃ e14, poss e14 x3 x15 ∧ _salad_n_1 x3) ∧
                        (∃ x6, property x6 ∧ ∃ e9, prpstn_to_prop e9 (∃ e2, unspec_a e2 x3) x6)
